            ...
            <div class="row">
                <div class="widget_text col-xl-3 col-lg-4 col-md-6">
                    <div class="footer-widget">
                        <a href="index.html" class="d-block mb-4" rel="home"><img width="220" src="{{ asset('frontend/assets/images/logo-alt.png')}}" class="custom-logo" alt="Sayara"></a>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-7 text-left">
                    <p>
                    Copyright © 2021 Khan Bike Rental All Rights Reserved. </p>
                </div>
